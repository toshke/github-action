...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const adjustedFile = basePath && fileFormat == 'lcov' ? lcov_processor_1.adjustLcovBasePath(file, basePath) : file;
            coveralls.handleInput({ file: adjustedFile, format: fileFormat }, (err, body) => {
                if (err) {
                    core.setFailed(err);
                }
                else {
